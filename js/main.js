...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const lightFaders = document.querySelectorAll(
    ".white-section .fade-in-content, .grey-section .fade-in-content"
  );
  ...
  const skillsAndIntro = document.querySelectorAll(
    ".skillsanimation, .intro-info p.lead"
  );
  ...
  // ---------- Profile text ----------
  const profileText = document.querySelectorAll(
    '[data-translate="profileText"]'
  );
  ...
  const contactElements = document.querySelectorAll(
    "#contact h1, #contact h5, #contact p.lead, #contact .contact-info > div"
  );
